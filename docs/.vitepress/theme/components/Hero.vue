...
const installCommand = 'brew install lvcoi/melliza/melliza'
    ...
    <div class="hero-container">
      ...
      <div class="hero-content">
        <h1 class="hero-headline">
          <span class="hero-title-gradient">Build Big Projects with Gemini</span>
        </h1>
        ...
        <div class="hero-actions">
          <a :href="withBase('/guide/')" class="btn-primary">Get Started</a>
          <a href="https://github.com/lvcoi/melliza" target="_blank" rel="noopener" class="btn-secondary">
        ...
        <div class="terminal-window">
          ...
          <div class="terminal-body">
            <div class="terminal-line line-1">
              ...
              <span class="terminal-command typing-1">brew install lvcoi/melliza/melliza</span>
            </div>
            <div class="terminal-line line-2">
              <span class="terminal-output output-1">==> Fetching lvcoi/melliza/melliza</span>
            </div>
            <div class="terminal-line line-3">
              <span class="terminal-output output-2">==> Downloading melliza-darwin-arm64.tar.gz</span>
            </div>
            <div class="terminal-line line-4">
              <span class="terminal-output output-3">==> Installing melliza</span>
            </div>
            ...
            <div class="terminal-line line-6">
              <span class="terminal-prompt">$</span>
              <span class="terminal-command typing-2">melliza new</span>
            </div>
            <div class="terminal-line line-7">
              <span class="terminal-output output-5">Creating project in .melliza/prds/main...</span>
            </div>
            <div class="terminal-line line-8">
              <span class="terminal-output output-6 text-tokyo-green">Launching Gemini to help you get started...</span>
            </div>
          </div>
        </div>
      </div>
